...
class DiscussionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $d1 = [
        	...
        	'title' => $t1,
        	'content' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras arcu urna, sollicitudin sit amet faucibus eget, dignissim et massa. Maecenas quis dui maximus, aliquam tellus vel, finibus augue.',
        	'channel_id' => 1,
        	'user_id' => 2,
        	'slug' => str_slug($t1),
